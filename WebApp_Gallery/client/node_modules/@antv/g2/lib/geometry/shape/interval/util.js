...
function getRectWithCornerRadius(points, coordinate, radius) {
    ...
    if (coordinate.isReflect('y')) {
        _b = swap(p0, p1), p0 = _b[0], p1 = _b[1];
        _c = swap(p2, p3), p2 = _c[0], p3 = _c[1];
    }
    if (coordinate.isReflect('x')) {
        _d = swap(p0, p3), p0 = _d[0], p3 = _d[1];
        _e = swap(p1, p2), p1 = _e[0], p2 = _e[1];
    }
    var path = [];
    /**
     *  p1 → p2
    ...
    _f = parseRadius([r1, r2, r3, r4], Math.min(abs(p3.x - p0.x), abs(p1.y - p0.y))).map(function (d) { return abs(d); }), r1 = _f[0], r2 = _f[1], r3 = _f[2], r4 = _f[3];
    if (coordinate.isTransposed) {
        _g = [r4, r1, r2, r3], r1 = _g[0], r2 = _g[1], r3 = _g[2], r4 = _g[3];
    }
    if (p0.y < p1.y /** 负数情况 */) {
