...
const playerColumns = [
    ...
    // column for Potential, with the ability to (numerically) sort ,
    {
        title: 'Potential',
        dataIndex: 'Potential',
        key: 'Potential',
    ...
    // column for Club, with the ability to (alphabetically) sort 
    {
        title: 'Club',
        dataIndex: 'Club',
        key: 'Club',
    ...
    //column for Value - no sorting required
    {
        title: 'Value',
        dataIndex: 'Value',
        key: 'Value'
                    ...
                    <Card>
                        ...
                        <Row gutter='30' align='middle' justify='center'>
                            ...
                            <Row gutter='30' align='middle' justify='left'>
                                ...
                                <Col flex={2} style={{ textAlign: 'right' }}>
                                {this.state.selectedPlayerDetails.Nationality} <img src={this.state.selectedPlayerDetails.Flag} referrerpolicy="no-referrer" alt={null} style={{height:'3vh', marginLeft: '1vw'}}/>
                                </Col>
                            </Row>
                            ...
                            <Row gutter='30' align='middle' justify='left'>
                                ...
                                <Col>Contract Valid Until: {this.state.selectedPlayerDetails.ContractValidUntil}</Col>
                            </Row>
                        </CardBody>
                        ...
                        <CardBody>
                            ...
                            <Divider/>
                                ...
                                {/*TASK 32: In case the player is a GK, show a radar chart (replacing 'null' below) with the labels: Agility, Ball Control, Passing, Positioning, Stamina, Strength */}
                                 {/*User Ternary Operator as `condition ? expressionIfTrue : expressionIfFalse` */}
                                     {/*{this.state.selectedPlayerDetails.BestPosition === 'GK'?null:*/}
